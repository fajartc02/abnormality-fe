...
const routes = [{
        ...
        children: [{
                ...
                component: () =>
                    import ('@/views/EAssignment.vue'),
            },
            {
                path: '/AddEmployees',
                name: 'Data Karyawan',
                component: () =>
                    import ('@/views/AddEmployees.vue'),
            },
            {
                path: '/EAbsensi',
                name: 'Absensi Karyawan',
                component: () =>
                    import ('@/views/EAbsensi.vue'),
            },
            {
                path: '/MappingJob',
                name: 'Mapping Job',
                component: () =>
                    import ('@/views/MappingJob.vue'),
            },

            {
                ...
                name: 'DashboardTool',
                component: () =>
                    import ('@/views/DashboardTool.vue'),
            },

            {
                ...
                name: 'ToolStatus',
                component: () =>
                    import ('@/views/TMS/ToolStatus.vue'),
            },
            {
                path: '/tool/register',
                name: 'ToolRegister',
                component: () =>
                    import ('@/views/TMS/ToolRegister.vue'),
            },
            {
                path: '/tool/section',
                name: 'ToolSection',
                component: () =>
                    import ('@/views/TMS/ToolSection.vue'),
            },
            {
                path: '/tool/drawing',
                name: 'MasterDrawing',
                component: () =>
                    import ('@/views/TMS/MasterDrawing.vue'),
            },
            {
                path: '/tool/machine',
                name: 'MasterMachine',
                component: () =>
                    import ('@/views/TMS/MasterMachine.vue'),
            },
            {
                path: '/tool/distribution',
                name: 'MasterDistribution',
                component: () =>
                    import ('@/views/TMS/MasterDistribution.vue'),
            },
            {
                path: '/tool/system',
                name: 'MasterSystem',
                component: () =>
                    import ('@/views/TMS/MasterSystem.vue'),
            },
            {
                path: '/planSchedule',
                name: 'PlanSchedule',
                component: () =>
                    import ('@/views/PlanSchedule.vue'),
            },

            {
                ...
                name: 'HistoryCoolant',
                component: () =>
                    import ('@/views/HistoryCoolant.vue'),
            },

            {
                ...
                name: 'ScheduleKuras',
                component: () =>
                    import ('@/views/MasterSchedule.vue'),
            },
